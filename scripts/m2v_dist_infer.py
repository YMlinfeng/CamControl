...
from src.utils import eval_setup, hashize, set_environments, data_to_bytes

from src.models.autoencoders.visual_tokenizer import VisualTokenizerConfig
# from src.models.autoencoders.vae_data_processor import (
#     ImageProcessorConfig,
#     bytes_to_image,
#     bytes_to_video,
# )
# from src.models.feat_encoder import FeatEncoder
...
class M2V:
    ...
    def inference(self, batch):
        ...
        video_data = (self.pipeline(prompt, generator=generator, batch=batch, **self.config.pipeline.call)["images"].cpu().to(torch.float32).numpy() * 255).astype(
            np.uint8
        )  # (B F) C H W
