...
hostfile=/m2v_intern/luoyawen/Coding/Kelin/m2v_camclone_v2/tools/hostfile/re_H200_6_2.txt
...
# 2. method && 3. name
method=1b_camclonemaster_rebuttal_RT_control
name=1b_camclonemaster_rebuttal_RT_control_plucker
...
mpirun --allow-run-as-root -np $np \
    -mca plm_rsh_args "-p ${Port}"  \
        ...
        -x NCCL_DEBUG=WARN \
		/m2v_intern/luoyawen/Miniconda/miniconda/envs/m2v0524/bin/python main.py "$METHOD_NAME" --experiment-name "$CONFIG_EXP" "${@:3}" \
