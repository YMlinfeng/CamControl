...
hostfile=/m2v_intern/luoyawen/Coding/Kelin/m2v_camclone_v2/tools/hostfile/H800_12.txt
...
# 2. method && 3. name
method=1b_camclonemaster_node_12_ablation_finetune_transformer
name=1b_camclonemaster_node_12_ablation_finetune_transformer
