...
hostfile=/m2v_intern/luoyawen/Coding/Kelin/m2v_camclone_v2/tools/hostfile/re_H200_3.txt
...
# 2. method && 3. name
method=1b_camclonemaster_rebuttal_dataset_half
name=1b_camclonemaster_rebuttal_dataset_half
