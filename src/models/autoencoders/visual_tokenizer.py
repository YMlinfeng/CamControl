...
class VisualTokenizerConfig(InstantiateConfig):
    ...
    """
    Scaling factor for the diffusion model. Supposed to be modified by the users.
    0.3217487373731399 for "/video/zhengmingwu/ckpts/3dvae_wogan_v0.0.1.ckpt"
    0.33148804985580266 for "/video/zhengmingwu/ckpts/3dvae_wogan_v0.0.2.ckpt"
    0.3394317911815621 for "/video/zhengmingwu/ckpts/3dvae_wogan_v0.0.3.ckpt"
    """
